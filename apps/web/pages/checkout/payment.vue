<template>
  <div class="space-y-6">
    ...
    <!-- Payment Methods -->
    <section class="card">
      <h2 class="text-base font-bold text-gray-900 mb-4">Select Payment Method</h2>
      <div class="space-y-3">
        <label
    ...
    <section v-if="selectedMethod === 'upi'" class="card">
      <h2 class="text-base font-bold text-gray-900 mb-4">Enter UPI ID</h2>
      <input
        v-model="upiId"
        type="text"
    ...
    <section v-if="selectedMethod === 'card'" class="card">
      <h2 class="text-base font-bold text-gray-900 mb-4">Card Details</h2>
      <div class="space-y-3">
