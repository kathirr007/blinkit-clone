  ...
  <div class="max-w-2xl mx-auto px-4 py-4">
    ...
    <div class="card mb-6">
      ...
      <div v-if="isEditing" class="space-y-4">
        ...
        <div class="flex gap-3">
          <button class="btn-secondary flex-1" @click="cancelEdit">
            Cancel
          </button>
      ...
      <div v-else class="space-y-3">
        ...
        <button class="btn-secondary w-full mt-4" @click="startEdit">
          Edit Profile
        </button>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="space-y-1">
        ...
        <button class="flex items-center justify-between p-3 rounded-lg hover:bg-red-50 transition-colors w-full" @click="handleLogout">
          <div class="flex items-center gap-3">
