  ...
  <div class="card">
    ...
    <div v-else>
      <p class="text-sm text-gray-600 mb-4">
        ...
        <button class="text-[#0c831f] font-medium ml-2 hover:underline" @click="otpSent = false">
          Change
        </button>
      </p>
      <div class="mb-4">
      ...
      <p class="text-center text-sm text-gray-500 mt-3">
        Didn't receive? <button class="text-[#0c831f] font-medium hover:underline" @click="sendOtp">
          Resend OTP
        </button>
      </p>
    </div>
    ...
    <div class="mt-6 pt-4 border-t border-gray-100 text-center">
      <p class="text-sm text-gray-600">
        ...
        <NuxtLink to="/signup" class="text-[#0c831f] font-medium hover:underline">
          Sign up
        </NuxtLink>
      </p>
    </div>
